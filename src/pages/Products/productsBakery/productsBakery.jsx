...
const ProductsBakery = () =>{
    const [products,setProducts] = useState(data.products_bakery.all)
  ...
  const [subCatsItem,setSubCatsItem] = useState([
    {title:"ALL",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Cookies_Muffins_092222_2.png"},
    {title:"Croissants & Danish",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Cakes_092222_1_1.png"},
    {title:"Bread & Loafs",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Buns_Rolls_092222_1.png"},
    {title:"Keto",img:"https://media.barakatfresh.ae/media/catalog/category/Donuts_1.png"},
    {title:"Donuts",img:"https://media.barakatfresh.ae/media/catalog/category/Keto_Pecan.png"},
    {title:"Buns & Rolls",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Bread_Loafs_092222_1.png"},

    {title:"Cookies & Muffins",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Croissants_Danish_092222_1_1.png"},

    {title:"Cakes",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Bakery_091922_2.png"},
])
...
const filterBySubcats = () => {
  ...
  if (selectSubCats === 'ALL') {
    setProducts(data.products_bakery.all)
    setTitle('Bakery')
    return;
  }

  if (selectSubCats === 'Croissants & Danish') {
    setProducts(data.products_bakery.croissants_danish)

    setTitle('Croissants & Danish')
  }
  if (selectSubCats === 'Bread & Loafs') {
    setProducts(data.products_bakery.bread_loafs)
   
    setTitle('Bread & Loafs')
  }
  if (selectSubCats === 'Keto') {
    setProducts(data.products_bakery.keto)
    
    setTitle('Keto')
  }
  if (selectSubCats === 'Donuts') {
    setProducts(data.products_bakery.donuts)
    
    setTitle('Donuts')
  }
  if (selectSubCats === 'Buns & Rolls') {
    setProducts(data.products_bakery.buns_rolls)
    
    setTitle('Buns & Rolls')
  }
  if (selectSubCats === 'Cookies & Muffins') {
    setProducts(data.products_bakery.cookies_muffins)
    
    setTitle('Cookies & Muffins')
  }
  if (selectSubCats === 'Cakes') {
    setProducts(data.products_bakery.cakes)
  ...
  const sortProductsByCountry = () => {
    let sortedProducts = [...data.products_bakery.all];
