...
const PageProductsFreshJuices = () =>{
    const [products,setProducts] = useState(data.products_fresh_juices.all)
  ...
  const [subCatsItem,setSubCatsItem] = useState([
    {title:"ALL",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Juices_091922_1_4.png"},
    {title:"Mocktails",img:"https://media.barakatfresh.ae/media/catalog/category/GI4A6319-1.png"},
    {title:"Family Packs",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_FamilyPacks_092022_2.png"},
    {title:"Shots",img:"https://media.barakatfresh.ae/media/catalog/category/Burn_Stubborn_1.png"},
    {title:"Cold Pressed",img:"https://media.barakatfresh.ae/media/catalog/category/Iced_Tea_1.png"},
    {title:"Iced Tea",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Juices_091922_2_1.png"},

    {title:"Juices",img:"https://media.barakatfresh.ae/media/catalog/category/green_chia.png"},

    {title:"Healthy Juice Range",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Smoothies_091922_1.png"},

    {title:"Smoothies",img:"https://media.barakatfresh.ae/media/catalog/category/myD_CoQ-10.png"},

    {title:"Juice Combos",img:"https://media.barakatfresh.ae/media/catalog/category/gi4a6307__1_.png"},
    {title:"myD Range",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Keto_092022_1.png"},
])


  const [title,setTitle] = useState('Fresh Juices')
...
const filterBySubcats = () => {
  ...
  if (selectSubCats === 'ALL') {
    setProducts(data.products_fresh_juices.all)
    setTitle('Fresh Juices')
    return;
  }

  if (selectSubCats === 'Mocktails') {
    setProducts(data.products_fresh_juices.mocktails)

    setTitle('Mocktails')
  }
  if (selectSubCats === 'Family Packs') {
    setProducts(data.products_fresh_juices.family_packs)
   
    setTitle('Family Packs')
  }
  if (selectSubCats === 'Shots') {
    setProducts(data.products_fresh_juices.shots)
    
    setTitle('Shots')
  }
  if (selectSubCats === 'Cold Pressed') {
    setProducts(data.products_fresh_juices.cold_pressed)
    
    setTitle('Cold Pressed')
  }
  if (selectSubCats === 'Iced Tea') {
    setProducts(data.products_fresh_juices.iced_tea)
    
    setTitle('Iced Tea')
  }
  if (selectSubCats === 'Juices') {
    setProducts(data.products_fresh_juices.juices)
    
    setTitle('Juices')
  }
  
  if (selectSubCats === 'Healthy Juice Range') {
    setProducts(data.products_fresh_juices.healthy_juice_range)
    
    setTitle('Healthy Juice Range')
  }
  if (selectSubCats === 'Smoothies') {
    setProducts(data.products_fresh_juices.smoothies)
    
    setTitle('Smoothies')
  }
  if (selectSubCats === 'Juice Combos') {
    setProducts(data.products_fresh_juices.juice_combos)
    
    setTitle('Juice Combos')
  }
  if (selectSubCats === 'myD Range') {
    setProducts(data.products_fresh_juices.myd_range)
...
const handleTagsSelectChange = (event) => {
  ...
  const sortProductsByCountry = () => {
    let sortedProducts = [...data.products_fresh_juices.all];
...
export default PageProductsFreshJuices