...
const PageProductsOrganics = () =>{
    const [products,setProducts] = useState(data.products_organics.all)
  ...
  const [subCatsItem,setSubCatsItem] = useState([
    {title:"ALL",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Grocery_092022_1.png"},
    {title:"Organic Vegetables",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_OrganicEggs_092022_1.png"},
    {title:"Organic Fruits",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_OrganicMilk_092022_2.png"},
    {title:"Organic Milk",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_OrganicFruits_092022_4.png"},
    {title:"Organic Eggs",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_OrganicVegetables_092022_2.png"},
    {title:"Grocery",img:"https://media.barakatfresh.ae/media/catalog/category/1457586_Organics_091922_3_2.png"},
])


  const [title,setTitle] = useState('Organics')
...
const filterBySubcats = () => {
  ...
  if (selectSubCats === 'ALL') {
    setProducts(data.products_organics.all)
    setTitle('Organics')
    return;
  }

  if (selectSubCats === 'Organic Vegetables') {
    setProducts(data.products_organics.organic_vegetables)

    setTitle('Organic Vegetables')
  }
  if (selectSubCats === 'Organic Fruits') {
    setProducts(data.products_organics.organic_fruits)
   
    setTitle('Organic Fruits')
  }
  if (selectSubCats === 'Organic Milk') {
    setProducts(data.products_organics.organic_milk)
    
    setTitle('Organic Milk')
  }
  if (selectSubCats === 'Organic Eggs') {
    setProducts(data.products_organics.organic_eggs)
    
    setTitle('Organic Eggs')
  }
  if (selectSubCats === 'Grocery') {
    setProducts(data.products_organics.grocery)
...
export default PageProductsOrganics